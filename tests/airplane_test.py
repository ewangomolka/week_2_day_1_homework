...
class AirplaneTest(unittest.TestCase):
    def setUp(self):
        ...
        glue = ["PVA"]
        self.airplane = Airplane("Boeing 747", crew, "Miami", glue)
    ...
    def test_check_if_crew_member_is_called_shirley_not_found(self):
        self.assertEqual("Don't call me Shirley", self.airplane.has_shirley())
        
    def test_check_if_crew_member_is_called_shirley_found(self):
        self.airplane.add_member("Shirley")
        self.assertEqual("Please, call me Shirley", self.airplane.has_shirley())
